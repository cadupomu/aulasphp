  ...
  <?php include('navbar.php'); ?>
    <div class="col-6 offset-3">
        ...
        <div class="mb-3 form-group">
          ...
          <input type="text" name="produto" id="produtoId" class="form-control" placeholder="Informe o nome do produto" required>
          <div id="helperProduto" class="form-text">Informe o nome do produto</div>
        </div>
        <div class="mb-3 form-group">
          <label for="valorId" class="form-label">Valor</label>
          <input type="number" name="valor" id="valorId" class="form-control" placeholder="Informe o valor do produto" required>
          <div id="helperValor" class="form-text">Informe o valor do produto</div>
        </div>
        <div class="mb-3 form-group">
          <label for="matriculaId" class="form-label">Quantidade</label>
          <input type="number" name="quantidade" id="quantidadeId" class="form-control" placeholder="Informe a quantidade do produto" required>
